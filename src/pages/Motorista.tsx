            ...
            <div className="container mx-auto px-4 z-10 grid md:grid-cols-2 gap-12 items-center">
                ...
                <div ref={titleRef} className="text-center md:text-left space-y-6">
                    <img
                        ...
                        className="h-16 md:h-24 w-auto object-contain mx-auto md:mx-0 drop-shadow-2xl"
                    />
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mt-8">
                        <a
                            ...
                            className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-400 hover:to-emerald-500 text-white font-bold py-4 px-8 rounded-xl shadow-lg shadow-green-500/25 transform hover:-translate-y-1 transition-all text-lg"
                        >
                        ...
                        <a
                            ...
                            className="inline-flex items-center justify-center gap-2 bg-white/10 border border-white/20 hover:bg-white/20 text-white font-bold py-4 px-8 rounded-xl transition-all"
                        >
                ...
                {/* Driver Card Mockup */}
                <div ref={cardRef} className="relative flex justify-center items-center mt-12 md:mt-0">
                    <div className="absolute -z-10 w-[300px] h-[500px] bg-green-600/20 rounded-full blur-[80px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none" />
    ...
    return (
        <section ref={sectionRef} id="calculadora" className="py-20 md:py-28 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-4 relative z-10">
                ...
                <div className="bg-white/[0.04] backdrop-blur-sm border border-white/[0.08] rounded-3xl p-6 md:p-10 space-y-8">
                    {/* Sliders */}
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <div className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 rounded-2xl p-5 text-center">
            ...
            <div className="max-w-5xl mx-auto px-4">
                ...
                <div ref={gridRef} className="grid grid-cols-1 sm:grid-cols-2 gap-5 md:gap-6">
                    {requirements.map((req, i) => (
                        <div key={i} className="bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] rounded-2xl p-6 hover:bg-white/[0.06] hover:border-white/10 transition-all duration-500 hover:-translate-y-1 group flex items-start gap-4">
                            <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${req.color} flex items-center justify-center text-white shrink-0 group-hover:scale-110 transition-transform duration-500 shadow-lg`}>
                                {req.icon}
                            </div>
                            <div>
        ...
        <section className="py-20 md:py-24 relative overflow-hidden">
            ...
            <div className="max-w-5xl mx-auto px-4 relative z-10">
                ...
                <div ref={gridRef} className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    {benefits.map((b, i) => (
                        <div key={i} className="bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] rounded-2xl p-6 hover:bg-white/[0.06] hover:border-green-500/20 transition-all duration-300 group">
