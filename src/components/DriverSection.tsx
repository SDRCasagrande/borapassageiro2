...
export function DriverSection() {
    const cardRef = useScrollAnimation<HTMLDivElement>({ type: 'slideLeft', delay: 0.2 });
    const textRef = useScrollAnimation<HTMLDivElement>({ type: 'fadeUp', delay: 0.3 });
        ...
        <section id="seja-um-motorista" className="py-24 relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    {/* Right Content */}
                    <div ref={textRef} className="space-y-8 text-center md:text-left">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <a
                                ...
                                className="inline-flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white font-bold py-4 px-8 rounded-xl shadow-lg shadow-green-500/20 transform hover:-translate-y-1 transition-all justify-center"
                            >
                            ...
                            <Link
                                to="/motorista"
                                className="inline-flex items-center gap-2 bg-white/10 border border-white/20 hover:bg-white/20 text-white font-bold py-4 px-8 rounded-xl transition-all justify-center"
                            >
                                Saiba mais →
                            </Link>
                        </div>
