            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div ref={gridRef} className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
                    {features.map((feature, index) => (
                        <div key={index} className="bg-white/[0.03] backdrop-blur-sm p-6 rounded-2xl border border-white/[0.06] hover:border-cyan-500/20 transition-all duration-500 hover:-translate-y-1 group">
                            <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${feature.color} flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-500 shadow-lg text-white`}>
                                {feature.icon}
                            </div>
